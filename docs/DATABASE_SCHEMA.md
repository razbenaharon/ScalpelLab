...
| `code` | TEXT | UNIQUE, NOT NULL | Auto-generated code: FirstInitial + LastInitial + YYMM (e.g., JD1510) |
...
VALUES ('Jane Doe', 'JD1510', '2015-10-01', '2020-10-01');
```

**Code Generation Logic**:
- Format: `{FirstInitial}{LastInitial}{YY}{MM}`
- Example: Jane Doe starting October 2015 → `JD1510`
