...
def load_config():
    ...
    # Ensure BoxMOT config exists (should be in config file)
    if "boxmot" not in config:
        raise ValueError(
            "BoxMOT configuration not found in 0_yolo_config.json. "
            "Please add 'boxmot' section to the config file."
        )
