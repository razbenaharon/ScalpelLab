...
DEFAULT_INPUT_ROOT = (
    Path(get_analyses_root()) if get_analyses_root else Path(r"F:\Room_8_Data\Analyses_Finale")
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-root", type=Path, default=DEFAULT_INPUT_ROOT, help="Analyses_Finale root")
